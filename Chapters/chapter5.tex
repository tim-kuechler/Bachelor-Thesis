...
\subsection{The Cityscapes dataset} \label{sec:5.4.1}
...
%
\subsubsection{Fréchet inception distance} \label{sec:fid}
...
\subsubsection{Pixel accuracy} \label{sec:acc}
...
\end{table}
\subsection{Results and Quantitative Comparisons} \label{sec:5.4.5}
